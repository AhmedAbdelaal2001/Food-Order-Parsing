...
class Preprocessor:
    ...
    def filter_and_clean_dataset(self, dataset_type="train", start=0, end=None):
        ...
        Parameters:
        - dataset_type (str): The type of dataset ('train', 'dev', 'test'). Defaults to 'train'.
        - start (int): The starting index of entries to process. Defaults to 0.
        - end (int): The ending index of entries to process. If None, processes until the end of the file.
        """
        if start < 0:
            start = 0

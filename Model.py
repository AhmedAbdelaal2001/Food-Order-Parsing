class Model:
    ...
    Make sure to NOT change the parameters of the predict_labels function. You can do whatever you want with the constructor,
    just don't change anything about the predict_labels
    ...
    def predict_labels(self, sentence):
        ...
        be ['i', 'want', 'pizza']. Just use the .split() function on the sentence.
